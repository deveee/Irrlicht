...
namespace irr
{
	...
	enum E_DEVICE_TYPE
	{
		...
		/** The SFML device works under all platforms supported by SFML but first must be compiled
		in by defining the _IRR_COMPILE_WITH_SFML_DEVICE_ macro in IrrCompileConfig.h */
		EIDT_SFML,
