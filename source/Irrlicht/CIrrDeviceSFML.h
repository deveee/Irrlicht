...
// This device code is based on the original SFML device implementation
// contributed by Shane Parker (sirshane).

#ifndef IRR_C_IRR_DEVICE_SFML_H_INCLUDED
#define IRR_C_IRR_DEVICE_SFML_H_INCLUDED
...
namespace irr
{
	class CIrrDeviceSFML : public CIrrDeviceStub, video::IImagePresenter
	{
	public:

		//! constructor
		CIrrDeviceSFML(const SIrrlichtCreationParameters& param);

		//! destructor
		virtual ~CIrrDeviceSFML();
		...
		public:
			...
			CCursorControl(CIrrDeviceSFML* dev)
...
#endif // IRR_C_IRR_DEVICE_SFML_H_INCLUDED
