...
IRRLICHT_LIB_PATH := $(LOCAL_PATH)/../../lib/Android-SFML
...
LOCAL_CFLAGS += -DNO_IRR_COMPILE_WITH_ANDROID_DEVICE_ -DNO_IRR_COMPILE_WITH_SDL_DEVICE_
...
SFML_PATH ?= $(error SFML_PATH variable is not set)

LOCAL_C_INCLUDES += $(SFML_PATH)/include
